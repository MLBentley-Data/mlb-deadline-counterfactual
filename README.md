...
***Runs Allowed Model:** Highly significant improvement in runs allowed prediction (Paired t-test: $t = -2.93, p = 0.0017$)[cite: 146].
...
Detroit attempted to solidify their playoff presence by adding veteran arms[cite: 192, 193]. 
