...
***Runs Allowed Model:** Significant improvement in runs allowed prediction (Paired t-test: $t = -2.93, p = 0.0017$).

***Win/Loss Classifier:** Achieved **57.96% accuracy** (compared to the baseline's 54.70%), yielding a highly significant 

**McNemar's test** result ($\chi^2 = 7.31, p = 0.0069$).
